...
import { Button, Container, SmallText } from "../assets/styles/elementStyles";
  ...
  return (
    <>
      <IntroContainer id="get-started">
        ...
        <SubTitle>Mastercraft Bamboo Monitor Riser</SubTitle>
        <BrandInfo>
          A beautiful & handcrafted monitor stand to reduce neck and eye strain.
        </BrandInfo>
        <StyledButton onClick={handleModalDisplay}>
          Back this project
        </StyledButton>
