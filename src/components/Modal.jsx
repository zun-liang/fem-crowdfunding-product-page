...
import { Button, Container, Price, SmallText, SubTitle, ViewportContainer } from "../assets/styles/elementStyles";
import ModalOption from "./children-components/ModalOption";
import { BambooStandInfo, BlackStandInfo, MahoganyStandInfo, ModalWelcome, NoRewardInfo } from "./children-components/SmallComponents";
...
const Label = styled.label`
  ...
  &:hover {
    ...
    color: ${({ numberLeft }) =>
      numberLeft > 0 ? "var(--moderate-cyan)" : ""};
  }
`;
...
const PledgeInput = styled.input`
  ...
  height: 100%;
  border: ${({ error }) =>
    error ? "1.5px solid red" : "1px solid var(--light-gray)"};
  border-radius: 30px;
  padding: 0 32%;
  font-family: "Commissioner", sans-serif;
  font-size: 0.9rem;
...
const Modal = (props) => {
  ...
  const handleErrorMessage = () => {
    ...
    if (selectPledge.pledge === "bamboo" && moneyBacked.bamboo === "") {
      ...
      moneyBacked.bamboo / 25 > numberLeft.bamboo
    ) {
      setErrorMessage((prev) => {
        return {
          ...prev,
      ...
      selectPledge.pledge === "bamboo" &&
      (moneyBacked.bamboo % 25 !== 0 || moneyBacked.bamboo <= 0)
    ) {
      setErrorMessage((prev) => {
        return {
          ...prev,
    ...
    if (selectPledge.pledge === "black" && moneyBacked.black === "") {
      ...
      moneyBacked.black / 75 > numberLeft.black
    ) {
      setErrorMessage((prev) => {
        return {
          ...prev,
      ...
      selectPledge.pledge === "black" &&
      (moneyBacked.black % 75 !== 0 || moneyBacked.black <= 0)
    ) {
      setErrorMessage((prev) => {
        return {
          ...prev,
    ...
    if (selectPledge.pledge === "mahogany" && moneyBacked.mahogany === "") {
      setErrorMessage((prev) => {
        return {
          ...prev,
      ...
      moneyBacked.mahogany / 200 > numberLeft.mahogany
    ) {
      setErrorMessage((prev) => {
        return {
          ...prev,
      ...
      selectPledge.pledge === "mahogany" &&
      (moneyBacked.mahogany % 200 !== 0 || moneyBacked.mahogany <= 0)
    ) {
      setErrorMessage((prev) => {
        return {
          ...prev,
  ...
  const handleContinueButton = () => {
    if (
      (selectPledge.pledge === "noreward" && moneyBacked.noreward > 0) ||
      (selectPledge.pledge === "bamboo" &&
        moneyBacked.bamboo > 0 &&
        moneyBacked.bamboo % 25 === 0 &&
        moneyBacked.bamboo / 25 <= numberLeft.bamboo) ||
      (selectPledge.pledge === "black" &&
        moneyBacked.black > 0 &&
        moneyBacked.black % 75 === 0 &&
        moneyBacked.black / 75 <= numberLeft.black) ||
      (selectPledge.pldge === "mahogany" &&
        moneyBacked.mahogany > 0 &&
        moneyBacked.mahogany % 200 === 0 &&
        moneyBacked.mahogany / 200 <= numberLeft.mahogany)
    ) {
      handleModalDisplay();
      handleCompleteDisplay();
      ...
      content: (
        <>
          <Wrapper>
            ...
            />
            <Label htmlFor="noreward" numberLeft={numberLeft.noreward}>
      ...
      content: (
        <>
          <Wrapper>
            ...
            />
            <div>
              <Label htmlFor="bamboo" numberLeft={numberLeft.bamboo}>
                Bamboo Stand
              </Label>
          ...
          <Number>
            {numberLeft.bamboo}
            <TextLeft as="span">left</TextLeft>
          </Number>
          {selectPledge.pledge === "bamboo" && (
            <>
              <Hr />
      ...
      content: (
        <>
          <Wrapper>
            ...
            />
            <div>
              <Label htmlFor="black" numberLeft={numberLeft.black}>
                Black Edition Stand
              </Label>
      ...
      content: (
        <>
          <Wrapper>
            ...
            />
            <div>
              <Label htmlFor="mahogany" numberLeft={numberLeft.mahogany}>
