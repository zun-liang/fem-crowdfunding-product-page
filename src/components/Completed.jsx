...
import { ViewportContainer, Container, Button, SmallText, SubTitle } from "../assets/styles/elementStyles"
    ...
    return(
        <ViewportContainer>
            <CompletedContainer>
                ...
                <SmallText>Your pledge brings us one step closer to sharing Mastercraft Bamboo Monitor Riser worldwide. You will get
