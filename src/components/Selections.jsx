...
import { Container, SubTitle, Price, SmallText } from '../assets/styles/elementStyles'
import { ProjectIntro, ProjectIntro2, BambooStandInfo, BlackStandInfo, MahoganyStandInfo } from "./children-components/SmallComponents"
...
const Selections = ({handleModalDisplay, numberLeft}) => {
    ...
    const handleSelectReward = e => setSelectReward({
    ...
    const options = [
        {
            ...
            content:
                <>
                    ...
                    <BambooStandInfo/>
                    <Number>{numberLeft.bamboo}<LeftSign as='span'>left</LeftSign></Number>
                    {numberLeft.bamboo > 0
                        ? <>
                            <SelectRadio 
                                type="radio" 
                            ...
                            />
                            <SelectLabel htmlFor="bamboo-stand" onClick={handleSelectButton}>Select Reward</SelectLabel>
                          </>
        ...
        },
        {
            ...
            content: 
                <>
                    ...
                    <BlackStandInfo/>
                    <Number>{numberLeft.black}<LeftSign as='span'>left</LeftSign></Number>
                    {numberLeft.black > 0
                        ? <>
                            <SelectRadio 
                                type="radio" 
                                ...
                                onChange={handleSelectReward} 
                            />
                            <SelectLabel htmlFor="black-stand" onClick={handleSelectButton}>Select Reward</SelectLabel>
                        </>
                        : <DisabledButton>Out of Stock</DisabledButton> 
                    }
                </>
        },
        {
            ...
            content: 
                <>
                    ...
                    <MahoganyStandInfo/>
                    <Number>{numberLeft.mahogany}<LeftSign as='span'>left</LeftSign></Number>
                    {numberLeft.mahogany > 0
                        ? <>
                            <SelectRadio 
                                ...
                                onChange={handleSelectReward} 
                            />
                            <SelectLabel htmlFor="mahogany-stand" onClick={handleSelectButton}>Select Reward</SelectLabel>
                          </>
                        : <DisabledButton>Out of Stock</DisabledButton>
                    }
                </>
